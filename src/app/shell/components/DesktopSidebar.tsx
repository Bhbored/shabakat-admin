  ...
  const sidebarContent = (
    <div className="flex h-full w-64 flex-col bg-sidebar text-sidebar-foreground">
      ...
      <div className="border-t border-sidebar-border px-4 py-4">
        ...
        <button className="flex w-full items-center justify-center gap-2 rounded-xl border border-sidebar-border px-3 py-2 text-sm text-muted-foreground transition-colors hover:text-foreground">
    ...
    <>
      ...
      {openMobile && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          />
          <aside className="fixed inset-y-0 left-0 z-50 shadow-lg">
            {sidebarContent}
          </aside>
        </div>
      )}
